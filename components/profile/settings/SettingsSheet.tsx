...
//     {/* Optional Description Text below the row */}
//     {description && (
//       <Text className="text-zinc-500 text-xs mt-2 leading-4 ml-10">
//         {description}
//       </Text>
//     )}
//   </View>
...
//         <SettingRow icon="person" label="Profile Photo" />
//         <SettingRow
//           icon="diamond-outline"
//           label="Gem Name"
//           value="Alexthegreat1"
//         />
//         <SettingRow icon="mail-outline" label="Email" value="Verify" />
//         <SettingRow icon="key-outline" label="Password" />
//         <SettingRow icon="call-outline" label="Phone" />
//         <SettingRow
...
//         <SettingRow icon="people-outline" label="Friends" />
//         <SettingRow icon="ticket-outline" label="Enter Referral Code" />
...
//         <SettingRow icon="qr-code-outline" label="Scan QR Code" />
